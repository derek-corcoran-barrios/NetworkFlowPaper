...
The studied area is shown in figure 1 and it encompases `r  prettyNum(round(as.numeric(st_area(sandes))/1000000,0), big.mark = ",")` square kilometers
...
Four GCM models were selected to project the species distribution using the GCMcompareR shiny app [@fajardo_javier_2018_2669407], we followed the storylines approach [@zappa2017storylines] and selected a GCM warmer and wetter, warmer and dryier, colder and wetter, adn colder and dryier than the ensemble.
